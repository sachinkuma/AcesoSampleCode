...
mejs.YouTubeApi = {
	...
	createIframe: function(settings) {
		...
		player = new YT.Player(settings.containerId, {
			...
			playerVars: {'controls':1, 'autoplay':1, 'allowfullscreen':0, 'frameborder':0, 'showinfo':0, 'rel':0, 'modestbranding':1, 'iv_load_policy':3},
			events: {
				'onReady': function() {
					...
					$('#'+settings.containerId).css({'position':'absolute', 'top':'0', 'left':'0', 'width':'100%', 'height':'100%'});			
				},
